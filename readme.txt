Description: Bits is a responsive time line theme licensed under the <a href="http://www.opensource.org/licenses/gpl-license.php">GPL</a>. Typography is also responsive based on flowtype.js. This theme is based on the Simon WP Framework. Bits theme comes with custom icons in jpg and svg. FlowType.JS by Simple Focus (http://simplefocus.com/) is licensed under the MIT License. Retina.js (http://retinajs.com/) is licensed under the MIT License.
